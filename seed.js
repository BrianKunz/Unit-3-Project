...
const Idea = require("./backend/models/ideaSchema");
...
(async function() {
  ...
  const ideas = await Idea.create([
    ...
    },
    {
      ...
      description: 'Gskyer Telescope, 70mm Aperture 400mm AZ Mount Astronomical Refracting Telescope for Kids Beginners - Travel Telescope with Carry Bag, Phone Adapter and Wireless Remote',
    ...
    },
    {
      ...
      description: "Can't Help Falling in Love Wood Music Box, Antique Engraved Musical Boxes Case for Love One Wooden Music Box",
      category: categories[1], 
    ...
    },
    {
      ...
      description: '24PCS Grill Tools Set BBQ Accessories for Outdoor Grill Utensils Stainless Steel Grilling Tools Set',
    ...
    },
    {
      ...
      description: 'Wearable Blanket Sweatshirt Gifts for Women and Men, Super Warm and Cozy Giant Blanket Hoodie, Thick Flannel Blanket with Sleeves and Giant Pocket - Dark Gray',
      category: categories[2], 
    ...
    },
    {
      ...
      description: 'Beard Kit for men - Beard Care Kit for Mens Gifts with Beard Oil, Beard Balm, Beard Brush, Comb, Scissors, Ebook',
    ...
    },
    {
      ...
      description: '200 Funny Jokes : Perfect Easter Basket Stuffer for Kids and for Teens & Adults ',
      category: categories[5], 
    ...
    },
    {
      ...
      description: 'BRIDAL Wedding Guest Book Registry Items Memory Scrapbook Album',
      category: categories[6], 
    ...
    },
    {
      ...
      description: 'Baby Prediction Cards For Baby Shower/Advice Cards/Baby Shower Decorations, (Set of 50) Baby Shower Game, One Size, kraft, white, 28440NA',
    ...
    },
    {
      ...
      description: 'MiniPod Baby Dome for On the Go | Travel Baby Tent for Beach Protects from Sun, Wind, Bugs | Lightweight Portable Baby Bed',
      category: categories[7], 
    ...
    },
    {
      ...
      description: 'I Graduated Can I Go Back To Bed Now T-Shirt Graduation T-Shirt',
    ...
    },
    {
      ...
      description: 'Charge your cell phone and keep your daily-used things at hand. Size assembled 5.9x10.4x7.4". Please note! Accessories shown in the pictures are not included!',
    ...
    },
    {
      ...
      description:" Three-layer power tool organizer wall mount, the top mesh shelf can store small tools without dropping, the middle shelf can store the toolbox and battery, four-slot electric drill holder with upturned anti-skid design, with four small tool storage accessories on both sides, for storing pliers, screwdriver, electric drill bit or hammer. You can easily store most of your tools with only one power tool storage rack, resulting in a neat workbench.",
      category: categories[9], 
    ...
    },
    {
      ...
      description:"10 Natural Scents-honey,coconut,rose,avocado,cherry blossoms,grapefruit,chamomile,shea butter,lavender,aloe vera. Pick and choose your favorite scent based on your mood at the moment from our 10 natural fragrances.",
    ...
    },
    {
      ...
      description: '【2023 FUNNY RETIREMENT GIFTS MUG】: Superior quality retirement gifts for men and women, "Fucking Quitter I Mean Happy Retirement" sign coffee mug, Humorous retirement gifts are sure to be the talk of the retirement party.',
      ...
      },
      {
        ...
        description: 'Full Package Gift Set - The gift set includes 1 handmade wooden box, 1 thick base 11oz whisky glass, 1 slate coaster, 4 natural granite stones, and 1 small gift card. All part of the gift set will be delivered in a delicate designed gift package.',
        category: categories[12], 
        ...
        },
    {
      ...
      description: 'Fit 2 Golf Bags and Other Golfing Equipment and Accessories in This Handy Storage Rack',
    ...
    },
    {
      ...
      description: 'RAK Telescoping Magnetic Pickup Tool - Extendable Magnetic Flashlight ',
      category: categories[14], 
